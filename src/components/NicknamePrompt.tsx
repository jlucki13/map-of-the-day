    ...
    <form onSubmit={submit} className="space-y-2">
      ...
      <div className="flex gap-2">
        ...
        <button
          ...
          className="rounded-control bg-accent px-4 py-2 text-sm font-semibold text-accent-ink transition duration-150 hover:bg-accent-hover active:translate-y-px disabled:cursor-not-allowed disabled:bg-ocean-700/40"
        >
